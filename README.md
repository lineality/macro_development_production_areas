...
Developer Voices Will Turso Be The Better SQLite? (with Glauber Costa)"
...
Phase 2. Earliest rough Project/Product-Scope Feature Design
 
Phase 3. POC (Proof of Concept)
- Test feasibility
- Test usefulness
- Get tangible feedback from people.
(The 'Agile' saying is: A useable POC is better than a proposal-report.)

Phase 4. MVP 1-N
- Refine a minimal but viable(!) scope of features.
- Initial versions are similar to a POC

Phase 5. Production Architecture 1-N
...
- Recreation, R&R
- Fads & Illusions
- Isomorphic Mimicry ("Cargo cults")
